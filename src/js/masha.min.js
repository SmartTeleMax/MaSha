...
0,d=b.length;c<d;c++)if(b[c]===a)return c;return-1}function h(a,b,c){a.addEventListener?a.addEventListener(b,c,!1):a.attachEvent&&a.attachEvent("on"+b,c)}function x(a){a.preventDefault?a.preventDefault():a.returnValue=!1}var y=function(){};y.prototype={set_hash:function(a){window.location.hash=a},get_hash:function(){return window.location.hash},add_hashchange:function(a){h(window,"hashchange",a)}};var k=function(a){this.options=s({},k.default_options,a);s(this,{counter:0,savedSel:[],ranges:{},childs:[],
blocks:{}});this.init()};k.version="";k.default_options={regexp:"[^\\s,;:\u2013.!?<>\u2026\\n\u00a0\\*]+",selectable:"selectable-content",marker:"txtselect_marker",ignored:null,select_message:null,location:new y,validate:!1,enable_haschange:!0,onMark:null,onUnmark:null,onHashRead:function(){var a=t(this.selectable,"user_selection_true");a&&!this.hash_was_read&&(this.hash_was_read=!0,window.setTimeout(function(){for(var b=0,c=0;a;)b+=a.offsetLeft,c+=a.offsetTop,a=a.offsetParent;window.scrollTo(b,c-
150)},1))},is_block:function(a){return"BR"==a.nodeName||-1==z(B(a,"display"),["inline","none"])}};k.prototype={init:function(){var a,b;function c(){var c=RegExp(f.options.regexp,"g"),d=window.getSelection().toString();""!=d&&c.test(d)&&f.range_is_selectable()&&(f.marker.style.top=a-33+"px",f.marker.style.left=b+5+"px",w(f.marker,"show"))}function d(c){c=c.touches.item(0);b=c.pageX;a=c.pageY}function e(a){x(a);a.stopPropagation?a.stopPropagation():a.cancelBubble=!0;r(f.marker,"show");f.range_is_selectable()&&
...
this.marker=this.options.marker;if("string"!=typeof this.options.regexp)throw"regexp is set as string";this.regexp=RegExp(this.options.regexp,"ig");var f=this;this.selectable&&(this.is_ignored=this.construct_ignored(this.options.ignored),this.options.select_message&&this.init_message(),this.enumerateElements(),h(this.selectable,"mouseup",function(d){if(d.pageX==null){var e=document.documentElement,f=document.body;b=d.clientX+(e&&e.scrollLeft||f&&f.scrollLeft||0)-(e.clientLeft||0);a=d.clientY+(e&&
e.scrollTop||f&&f.scrollTop||0)-(e.clientTop||0)}else{b=d.pageX;a=d.pageY}window.setTimeout(c,1)}),h(this.selectable,"touchmove",d),h(this.selectable,"touchstart",d),h(this.selectable,"touchend",function(){window.setTimeout(function(){var d=window.getSelection();if(d.rangeCount){d=d.getRangeAt(0).getClientRects();if(d=d[d.length-1]){b=d.left+d.width+document.body.scrollLeft;a=d.top+d.height/2+document.body.scrollTop}}c()},1)}),h(this.marker,"click",e),h(this.marker,"touchend",e),h(document,"click",
...
a=this.checkSelection(a),a=this.mergeSelections(a),b="num"+this.counter;this.ranges[b]=this.serializeRange(a);a.wrapSelection(b+" user_selection_true");this.addSelectionEvents(b)},addSelectionEvents:function(a){for(var b=!1,c=this,d=v(this.selectable,a),e=d.length;e--;)h(d[e],"mouseover",function(){for(var a=d.length;a--;)w(d[a],"hover");window.clearTimeout(b)}),h(d[e],"mouseout",function(a){for(a=a.relatedTarget;a&&a.parentNode&&a.className!=this.className;)a=a.parentNode;if(!a||a.className!=this.className)b=
...
null},enumerateElements:function(){function a(d){for(var d=d.childNodes,e=!1,f=!1,j=0;j<d.length;++j){var g=d.item(j),h=g.nodeType;if(3!=h||g.nodeValue.match(c.regexp))3==h?f||(b++,e=document.createElement("span"),e.id="selection_index"+b,e.className="selection_index",g.parentNode.insertBefore(e,g),j++,c.blocks[b]=g,e=f=!0):1==h&&!c.is_ignored(g)&&(c.options.is_block(g)?(g=a(g),e=e||g,f=!1):f||(f=a(g),e=e||f))}return e}var b=0,c=this;a(this.selectable)},isFirstTextNode:function(a){for(var a=[a.previousSibling,
a.parentNode.previousSibling],b=a.length;b--;)if(a[b]&&1==a[b].nodeType&&"selection_index"==a[b].className)return!0;return!1},getFirstTextNode:function(a){return!a?null:(a=document.getElementById("selection_index"+a))?1==a.nextSibling.nodeType?a.nextSibling.childNodes[0]:a.nextSibling:null},getNum:function(a){for(;a.parentNode;){for(;a.previousSibling;){for(a=a.previousSibling;1==a.nodeType&&a.childNodes.length;)a=a.lastChild;if(1==a.nodeType&&"selection_index"==a.className)return a.id.replace("selection_index",
...
p.prototype.splitBoundaries=function(){var a=this.startContainer,b=this.startOffset,c=this.endContainer,d=this.endOffset,e=a===c;3==c.nodeType&&d<c.length&&c.splitText(d);3==a.nodeType&&0<b&&(a=a.splitText(b),e&&(d-=b,c=a),b=0);this.setStart(a,b);this.setEnd(c,d)};p.prototype.getTextNodes=function(){for(var a=this.getElementIterator(),b=[],c;c=a();)3==c.nodeType&&b.push(c);return b};p.prototype.getElementIterator=function(a){return a?m(null,this.endContainer,this.startContainer,!0):m(null,this.startContainer,
this.endContainer)};p.prototype.getWordIterator=function(a,b){var c=this.getElementIterator(b),d,e=0,f=0,h=!1,g,k=this;return function(){if(e==f&&!h){do{do d=c();while(d&&3!=d.nodeType);h=!d;h||(value=d.nodeValue,d==k.endContainer&&(value=value.substr(0,k.endOffset)),d==k.startContainer&&(value=value.substr(k.startOffset)),g=value.match(a))}while(d&&!g);g&&(e=b?0:g.length-1,f=b?g.length-1:0)}else b?f--:f++;return h?null:g[f]}};p.prototype.wrapSelection=function(a){this.splitBoundaries();for(var b=
this.getTextNodes(),c=b.length;c--;){var d=document.createElement("span");d.className=a;b[c].parentNode.insertBefore(d,b[c]);d.appendChild(b[c])}};k.LocationHandler=y;window.MaSha=k;window.jQuery&&(window.jQuery.fn.masha=function(a){a=a||{};a=s({selectable:this[0]},a);return new k(a)});var A=function(a){this.prefix=a};A.prototype={set_hash:function(a){a=a.replace("sel",this.prefix).replace(/^#/,"");a.length==this.prefix.length+1&&(a="");var b=this.get_hash_part();window.location.hash.replace(/^#\|?/,
"");a=b?window.location.hash.replace(b,a):window.location.hash+"|"+a;a="#"+a.replace("||","").replace(/^#?\|?|\|$/g,"");window.location.hash=a},add_hashchange:k.LocationHandler.prototype.add_hashchange,get_hash_part:function(){for(var a=window.location.hash.replace(/^#\|?/,"").split("|"),b=0;b<a.length;b++)if(a[b].substr(0,this.prefix.length+1)==this.prefix+"=")return a[b];return""},get_hash:function(){return this.get_hash_part().replace(this.prefix,"sel")}};window.MultiMaSha=function(a,b){for(var b=
b||function(a){return a.id},c=0;c<a.length;c++){var d=a[c],e=b(d);e&&new k({selectable:d,location:new A(e)})}}})();
