(function(){function l(a,b,c){function d(){if(e)return null;var g=b;if(b.childNodes&&b.childNodes.length&&!f)b=b.firstChild;else if(b.nextSibling)b=b.nextSibling,f=!1;else if(b.parentNode)b=b.parentNode,b===a&&(e=!0),f=!0,d();g===c&&(e=!0);return g}var b=b||a.childNodes[0],e=!b,f=!1;return d}function q(a){for(var b=1;b<arguments.length;b++)for(key in arguments[b])a[key]=arguments[b][key];return a}function n(a){return(a||"").replace(/^\s+|\s+$/g,"")}function y(a,b){var c="";document.defaultView&&document.defaultView.getComputedStyle?
c=document.defaultView.getComputedStyle(a,"").getPropertyValue(b):a.currentStyle&&(b=b.replace(/\-(\w)/g,function(a,b){return b.toUpperCase()}),c=a.currentStyle[b]);return c}function o(a,b){for(;a&&!j(b).test(a.className);)a=a.parentNode;return a||null}function r(a,b){for(var c=l(a),d;d=c();)if(d.nodeType==1&&j(b).test(d.className))return d}function s(a){for(var a=l(a),b;b=a();)if(b.nodeType==3)return b}function t(a,b){if(a.getElementsByClassName)return a.getElementsByClassName(b);else{for(var c=
[],d,e=l(a);d=e();)d.nodeType==1&&j(b).test(d.className)&&c.push(d);return c}}function u(a){for(var b=[],c=l(a);a=c();)a.nodeType==3&&b.push(a);return b}function j(a){return RegExp("(^|\\s+)"+a+"(?:$|\\s+)","g")}function w(a,b){if(!j(b).test(a.className))a.className=a.className+" "+b}function v(a,b){var c=j(b);if(c.test(a.className))a.className=n(a.className.replace(c,"$1"))}function x(a,b){for(var c=0,d=b.length;c<d;c++)if(b[c]===a)return c;return-1}function k(a,b,c){a.addEventListener?a.addEventListener(b,
c,!1):a.attachEvent&&a.attachEvent("on"+b,c)}function z(a){if(a.pageX==null){var b=document.documentElement,c=document.body;return{x:a.clientX+(b&&b.scrollLeft||c&&c.scrollLeft||0)-(b.clientLeft||0),y:a.clientY+(b&&b.scrollTop||c&&c.scrollTop||0)-(b.clientTop||0)}}return{x:a.pageX,y:a.pageY}}var m=function(a){this.options=q({},m.default_options,a);q(this,{counter:0,savedSel:[],ranges:{},childs:[],blocks:{}});this.init()};m.default_options={regexp:"[^\\s,;:\u2013.!?<>\u2026\\n\u00a0\\*]+",selectable:"selectable-content",
marker:"txtselect_marker",location:window.location,ignored:null,onMark:null,onUnmark:null,onHashRead:function(){var a=r(this.selectable,"user_selection_true");a&&window.setTimeout(function(){for(var b=0,c=0;a;)b+=a.offsetLeft,c+=a.offsetTop,a=a.offsetParent;window.scrollTo(b,c-150)},1)},is_block:function(a){return a.nodeName=="BR"||x(y(a,"display"),["inline","none"])==-1}};m.prototype={init:function(){this.selectable=typeof this.options.selectable=="string"?document.getElementById(this.options.selectable):
...
"end");return b+","+a},checkSelection:function(a){this.checkPosition(a,a.startOffset,a.startContainer,"start");this.checkPosition(a,a.endOffset,a.endContainer,"end");this.checkBrackets(a);this.checkSentence(a);return a},checkPosition:function(a,b,c,d){function e(a){return a.match(j.regexp)!=null}function f(a){return a.match(j.regexp)==null}function g(a,b,c){for(;b>0&&c(a.data.charAt(b-1));)b--;return b}function h(a,b,c){for(;b<a.data.length&&c(a.data.charAt(b));)b++;return b}var j=this;if(d=="start"){if(c.nodeType==
1&&n(c.textContent||c.innerText)!=""){if(a.startContainer.nodeType==1)for(c=a.startContainer.childNodes[a.startOffset];c.nodeType!=3;)c=c.nextSibling;else c=s(c);b=0}if(c.nodeType!=3||c.data.substring(b).match(this.regexp)==null)b=this.nextNode(c),c=b._container,b=b._offset;b=h(c,b,f);b=g(c,b,e);a.setStart(c,b)}if(d=="end"){if(c.nodeType==1&&n(c.textContent||c.innerText)!=""&&b!=0){for(c=a.endContainer.childNodes[a.endOffset-1];c.nodeType!=3;)c=c.previousSibling;b=c.data.length}if(c.nodeType!=3||
c.data.substring(0,b).match(this.regexp)==null)b=this.prevNode(c),c=b._container,b=b._offset;b=g(c,b,f);b=h(c,b,e);a.setEnd(c,b)}},checkBrackets:function(a){this._checkBrackets(a,"(",")",/\(|\)/g,/\(x*\)/g);this._checkBrackets(a,"\u00ab","\u00bb",/\\u00ab|\\u00bb/g,/\u00abx*\u00bb/g)},_checkBrackets:function(a,b,c,d,e){var f=a.toString();if(d=f.match(d)){for(var d=d.join(""),g=d.length+1;d.length<g;)g=d.length,d=d.replace(e,"x");d.charAt(d.length-1)==c&&f.charAt(f.length-1)==c&&(a.endOffset==1?(c=
this.prevNode(a.endContainer),a.setEnd(c.container,c.offset)):a.setEnd(a.endContainer,a.endOffset-1));d.charAt(0)==b&&f.charAt(0)==b&&(a.startOffset==a.startContainer.data.length?(c=this.nextNode(a.endContainer),a.setStart(c.container,c.offset)):a.setStart(a.startContainer,a.startOffset+1))}},checkSentence:function(a){function b(){a.setEnd(c._container,c._offset+1)}if(a.endOffset==a.endContainer.data.length){var c=this.nextNode(a.endContainer,/.*/);if(!c)return;var d=c._container.data.charAt(0)}else c=
...
a.startContainer.data.substring(0,a.startOffset);if(!d.match(/\S/))d=this.prevNode(a.startContainer,/\W*/)._container.data;d=n(d);if(d.charAt(d.length-1).match(/(\.|\?|\!)/))return b()}}},mergeSelections:function(a){var b=[],c=a.getElementIterator(),d=c(),e=d,f=o(d,"user_selection_true");f&&(f=/(num\d+)(?:$| )/.exec(f.className)[1],a.setStart(s(r(this.selectable,f)),0),b.push(f));for(;d;)d.nodeType==1&&j("user_selection_true").test(d.className)&&(e=/(num\d+)(?:$|)/.exec(d.className)[0],x(e,b)==-1&&
b.push(e)),e=d,d=c();if(e=o(e,"user_selection_true")){var e=/(num\d+)(?:$| )/.exec(e.className)[1],g;(c=t(this.selectable,e))&&(g=c[c.length-1]);g=u(g);g=g[g.length-1];a.setEnd(g,g.length)}if(b.length)g=a.startContainer,c=a.startOffset,d=a.endContainer,e=a.endOffset,this.delete_selections(b),a.setStart(g,c),a.setEnd(d,e);return a},addSelection:function(a){var a=a||this.getFirstRange(),a=this.checkSelection(a),a=this.mergeSelections(a),b="num"+this.counter;this.ranges[b]=this.serializeRange(a);a.wrapSelection(b+
" user_selection_true");this.addSelectionEvents(b)},addSelectionEvents:function(a){for(var b=!1,c=this,d=t(this.selectable,a),e=d.length;e--;)k(d[e],"mouseover",function(){for(var a=d.length;a--;)w(d[a],"hover");window.clearTimeout(b)}),k(d[e],"mouseout",function(a){for(a=a.relatedTarget;a&&a.parentNode&&a.className!=this.className;)a=a.parentNode;if(!a||a.className!=this.className)b=window.setTimeout(function(){for(var a=d.length;a--;)v(d[a],"hover")},2E3)});e=document.createElement("a");e.className=
