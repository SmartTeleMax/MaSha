...
return b}var j=this;if(c.nodeType==1&&b>0)b<c.childNodes.length?(c=c.childNodes[b],b=0):(container_txtnodes=m(c),c=container_txtnodes[container_txtnodes.length-1],b=c.data.length);if(d=="start"){if(c.nodeType==1&&o(c.textContent||c.innerText)!="")c=t(c),b=0;if(c.nodeType!=3||c.data.substring(b).match(this.regexp)==null)b=this.nextNode(c),c=b._container,b=b._offset;b=h(c,b,f);b=g(c,b,e);a.setStart(c,b)}if(d=="end"){if(c.nodeType==1&&o(c.textContent||c.innerText)!=""&&b!=0)c=c.childNodes[a.endOffset-
1],container_txtnodes=m(c),c=container_txtnodes[container_txtnodes.length-1],b=c.data.length;if(c.nodeType!=3||c.data.substring(0,b).match(this.regexp)==null)b=this.prevNode(c),c=b._container,b=b._offset;b=g(c,b,f);b=h(c,b,e);a.setEnd(c,b)}},checkBrackets:function(a){this._checkBrackets(a,"(",")",/\(|\)/g,/\(x*\)/g);this._checkBrackets(a,"\u00ab","\u00bb",/\\u00ab|\\u00bb/g,/\u00abx*\u00bb/g)},_checkBrackets:function(a,b,c,d,e){var f=a.toString();if(d=f.match(d)){for(var d=d.join(""),g=d.length+1;d.length<
...
j("user_selection_true").test(d.className)&&(e=/(num\d+)(?:$|)/.exec(d.className)[0],x(e,b)==-1&&b.push(e)),e=d,d=c();if(e=p(e,"user_selection_true")){var e=/(num\d+)(?:$| )/.exec(e.className)[1],g;(c=u(this.selectable,e))&&(g=c[c.length-1]);g=m(g);g=g[g.length-1];a.setEnd(g,g.length)}if(b.length)g=a.startContainer,c=a.startOffset,d=a.endContainer,e=a.endOffset,this.delete_selections(b),a.setStart(g,c),a.setEnd(d,e);return a},addSelection:function(a){var a=a||this.getFirstRange(),a=this.checkSelection(a),
